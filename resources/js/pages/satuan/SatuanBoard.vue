...
<script>
import { readSatuanCollection, createSatuan, updateSatuan, deleteSatuan } from '../../network/api';
...
export default {
    ...
    methods: {
        ...
        applyFilter() {
            ...
            readSatuanCollection(this.filterParams)
                .then(res => {
        ...
        onSubmitUpdate(submission) {
            this.formModalProps.isLoading = true;
            updateSatuan(submission.id, submission)
                .then(res => {
                    this.isFormModalActive = false;
                    this.$buefy.notification.open({
