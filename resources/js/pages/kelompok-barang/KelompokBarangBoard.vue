...
<script>
import { readKelompokKegiatanCollection, readKelompokBarangCollection, createKelompokBarang, updateKelompokBarang, deleteKelompokBarang } from '../../network/api';
import KelompokBarangForm from '../../components/kelompok-barang/KelompokBarangForm';
...
export default {
    ...
    methods: {
        ...
        applyFilter() {
            ...
            readKelompokBarangCollection(this.filterParams)
                .then(res => {
